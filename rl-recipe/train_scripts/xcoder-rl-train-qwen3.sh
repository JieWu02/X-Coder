...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files="[\"./syn_rl_data/xcoder_data/sorted_by_passrate/part_0000.parquet\",\"./syn_rl_data/xcoder_data/sorted_by_passrate/part_0001.parquet\",\"./syn_rl_data/xcoder_data/sorted_by_passrate/part_0002.parquet\",\"./syn_rl_data/xcoder_data/sorted_by_passrate/part_0003.parquet\"]" \
    ...
    actor_rollout_ref.model.path=./models/qwen3-base-sft-ckpt-3300 \
    ...
    actor_rollout_ref.rollout.repetition_penalty=1.15 \
    ...
    trainer.experiment_name="Qwen3-RL" \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=2 \
    trainer.default_local_dir=./checkpoints/qwen3-rl \
    trainer.default_hdfs_dir=null \
    trainer.save_freq=5 \
    trainer.test_freq=1000 \
    trainer.total_epochs=5 2>&1 | tee rl-test.log
