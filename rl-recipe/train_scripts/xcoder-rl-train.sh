...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path="IIGroup/X-Coder-SFT-Qwen2.5-7B" \
    ...
    trainer.experiment_name="RL-Gemini-Syn-Qwen2-Coder-2ep" \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.default_local_dir=./checkpoints/x-coder-qwen2-rl \
